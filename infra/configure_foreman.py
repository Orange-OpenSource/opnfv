...
for os, data in operatingSystems.items():
    ...
    # for tpl in templates:
        # foreman.operatingSystems[os]['os_default_templates'] +=\
            # {"config_template_id": foreman.configTemplates[tpl]['id'],
             # "template_kind_id": foreman.configTemplates[tpl][
                 # 'template_kind_id']}
        # p.status(bool(tpl in foreman.operatingSystems[os]
